				...
				<tr style="padding-top: 10px; padding-bottom: 10px;">
					<td colspan="2">
						...
						<c:forEach items="${order.orderItemList }" var="orderItem">
							<a class="link2" href="<c:url value='/PetServlet?method=load&bid=${orderItem.pet.bid }'/>">
								<img border="0" width="70" src="<c:url value='/${orderItem.pet.image_b }'/>" />
							</a>
						</c:forEach>
					...
					<td>
						<a href="<c:url value='/OrderServlet?method=load&oid=${order.oid }'/>">查看</a>
						<br />
