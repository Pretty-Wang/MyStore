				...
				<c:forEach items="${cartItemList }" var="cartItem">
					<tr align="center">
						...
						<td align="left" width="70px">
							<a class="linkImage" href="<c:url value='/jsps/pets/desc.jsp'/>">
								<img border="0" width="54" align="top" src="<c:url value='/${cartItem.pet.image_b }'/>" />
							</a>
						</td>
						<td align="left" width="400px">
							<a href="<c:url value='/jsps/pets/desc.jsp'/>">
								<span>${cartItem.pet.bname }</span>
							</a>
						</td>
						<td>
							<span>
								&yen;
								<span class="currPrice">${cartItem.pet.currPrice }</span>
							</span>
						</td>
						<td>
